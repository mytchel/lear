...
char *text[] = {
    ...
    "KING LEAR: Thou hast her, France: let her be thine; for we Have no such daughter, nor shall ever see That face of hers again. Therefore be gone Without our grace, our love, our benison. Come, noble Burgundy. Flourish. Exeunt all but KING OF FRANCE, GONERIL, REGAN, and CORDELIA",
    ...
    "KING OF FRANCE: Come, my fair Cordelia. Exeunt KING OF FRANCE and CORDELIA",
    ...
    "GONERIL: We must do something, and i' the heat. Exeunt",
    ...
    "EDMUND: I do serve you in this business. Exit EDGAR A credulous father! and a brother noble, Whose nature is so far from doing harms, That he suspects none: on whose foolish honesty My practises ride easy! I see the business. Let me, if not by birth, have lands by wit: All with me's meet that I can fashion fit. Exit",
    "SCENE III. The Duke of Albany's palace. Enter GONERIL, and OSWALD, her steward",
    ...
    "OSWALD: Well, madam.",
    "GONERIL: And let his knights have colder looks among you; What grows of it, no matter; advise your fellows so: I would breed from hence occasions, and I shall, That I may speak: I'll write straight to my sister, To hold my very course. Prepare for dinner. Exeunt",
    ...
    "SCENE V. Court before the same. Enter KING LEAR, KENT, and Fool",
    ...
    "ACT II:",
    "SCENE I. GLOUCESTER's castle. Enter EDMUND, and CURAN meets him",
    ...
    "SCENE II. Before Gloucester's castle. Enter KENT and OSWALD, severally",
    ...
    "OSWALD: Help, ho! murder! murder! Enter EDMUND, with his rapier drawn, CORNWALL, REGAN, GLOUCESTER, and Servants",
    ...
    "REGAN: My sister may receive it much more worse, To have her gentleman abused, assaulted, For following her affairs. Put in his legs. KENT is put in the stocks Come, my good lord, away. Exeunt all but GLOUCESTER and KENT",
    ...
    "SCENE IV. Before GLOUCESTER's castle. KENT in the stocks. Enter KING LEAR, Fool, and Gentleman",
    ...
    "KING LEAR: Ask her forgiveness? Do you but mark how this becomes the house: 'Dear daughter, I confess that I am old; Kneeling Age is unnecessary: on my knees I beg That you'll vouchsafe me raiment, bed, and food.'",
    ...
    "GLOUCESTER: Alack, the night comes on, and the bleak winds Do sorely ruffle; for many miles a bout There's scarce a bush.",
    ...
    "CORNWALL: Shut up your doors, my lord; 'tis a wild night: My Regan counsels well; come out o' the storm. Exeunt",
    "ACT III:",
    ...
    "KENT: Few words, but, to effect, more than all yet; That, when we have found the king,--in which your pain That way, I'll this,--he that first lights on him Holla the other. Exeunt severally",
    "SCENE II. Another part of the heath. Storm still. Enter KING LEAR and Fool",
    ...
    "KING LEAR: True, my good boy. Come, bring us to this hovel. Exeunt KING LEAR and KENT",
    ...
    "SCENE III. Gloucester's castle. Enter GLOUCESTER and EDMUND",
    ...
    "SCENE IV. The heath. Before a hovel. Enter KING LEAR, KENT, and Fool",
    ...
    "KENT: What art thou that dost grumble there i' the straw? Come forth. Enter EDGAR disguised as a mad man",
    ...
    "SCENE V. Gloucester's castle. Enter CORNWALL and EDMUND",
    ...
    "SCENE VI. A chamber in a farmhouse adjoining the castle. Enter GLOUCESTER, KING LEAR, KENT, Fool, and EDGAR",
    ...
    "KING LEAR: It shall be done; I will arraign them straight. To EDGAR Come, sit thou here, most learned justicer; To the Fool Thou, sapient sir, sit here. Now, you she foxes!",
    ...
    "KING LEAR: I'll see their trial first. Bring in the evidence. To EDGAR Thou robed man of justice, take thy place; To the Fool And thou, his yoke-fellow of equity, Bench by his side: To KENT you are o' the commission, Sit you too.",
    ...
    "GLOUCESTER: Come, come, away. Exeunt all but EDGAR",
    ...
    "SCENE VII. Gloucester's castle. Enter CORNWALL, REGAN, GONERIL, EDMUND, and Servants",
    ...
    "CORNWALL: Edmund, farewell. Exeunt GONERIL, EDMUND, and OSWALD Go seek the traitor Gloucester, Pinion him like a thief, bring him before us. Exeunt other Servants Though well we may not pass upon his life Without the form of justice, yet our power Shall do a courtesy to our wrath, which men May blame, but not control. Who's there? the traitor? Enter GLOUCESTER, brought in by two or three",
    ...
    "SCENE II. Before ALBANY's palace. Enter GONERIL and EDMUND",
    ...
    "GONERIL: Marry, your manhood now-- Enter a Messenger",
    "ALBANY: What news?",
    ...
    "ALBANY: Gloucester, I live To thank thee for the love thou show'dst the king, And to revenge thine eyes. Come hither, friend: Tell me what more thou know'st. Exeunt",
    "SCENE III. The French camp near Dover. Enter KENT and a Gentleman",
    ...
    "SCENE IV. The same. A tent. Enter, with drum and colours, CORDELIA, Doctor, and Soldiers",
    ...
    "SCENE V. Gloucester's castle. Enter REGAN and OSWALD",
    ...
    "SCENE VI. Fields near Dover. Enter GLOUCESTER, and EDGAR dressed like a peasant",
    ...
    "EDGAR: Give me your hand: Drum afar off Far off, methinks, I hear the beaten drum: Come, father, I'll bestow you with a friend. Exeunt",
    ...
    "KING LEAR: You must bear with me: Pray you now, forget and forgive: I am old and foolish. Exeunt all but KENT and Gentleman",
    ...
    "ACT V:",
    "SCENE I. The British camp, near Dover. Enter, with drum and colours, EDMUND, REGAN, Gentlemen, and Soldiers.",
    ...
    "EDMUND: Fear me not: She and the duke her husband! Enter, with drum and colours, ALBANY, GONERIL, and Soldiers",
    ...
    "GONERIL: [Aside] O, ho, I know the riddle.--I will go. As they are going out, enter EDGAR disguised",
    ...
    "ALBANY: Why, fare thee well: I will o'erlook thy paper. Exit EDGAR Re-enter EDMUND",
    ...
    "SCENE II. A field between the two camps. Alarum within. Enter, with drum and colours, KING LEAR, CORDELIA, and Soldiers, over the stage; and exeunt  Enter EDGAR and GLOUCESTER",
    ...
    "GLOUCESTER: Grace go with you, sir! Exit EDGAR Alarum and retreat within. Re-enter EDGAR",
    ...
    "SCENE III. The British camp near Dover. Enter, in conquest, with drum and colours, EDMUND, KING LEAR and CORDELIA, prisoners; Captain, Soldiers, & c",
    ...
    "ALBANY: The weight of this sad time we must obey; Speak what we feel, not what we ought to say. The oldest hath borne most: we that are young Shall never see so much, nor live so long. Exeunt, with a dead march",
    NULL
};
...
void sigintHandler(int sig_num) {
    printf("Do you not appreciate this? Have another read. At least get to line %i\n", MIN + 1);

    if (current_line >= MIN)
        stop_being_a_cunt = 1;
    else {
        current_line = -1; // -1 because the loop will increment it at the next step.
...
int main() {
    ...
    for (current_line = 0; text[current_line]; current_line++) {
